...
const loadAllPages = async () => {
  intro = await loadPage('intro.html');
  medical = await loadPage('medical.html');
 ...
 * The functtion is invoked when any link is clicked in the html.
